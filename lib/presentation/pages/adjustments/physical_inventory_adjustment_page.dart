...
class PhysicalInventoryAdjustmentPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ajuste de Inventario Físico'),
        actions: [
...
class _AddProductDialogState extends ConsumerState<_AddProductDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: const Text('Agregar Ajuste de Inventario'),
      content: SizedBox(
          ...
          children: [
            if (_selectedProduct == null) ...[
              ...
              Row(
                children: [
                  ...
                  ToggleButtons(
                    ...
                    children: [
                      Icon(Icons.add, color: AppTheme.transactionSuccess),
                      Icon(
                        Icons.remove,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Motivo *',
                  hintText: 'Ej. Conteo físico, Inventario inicial',
                ),
              ),
            ],
          ],
