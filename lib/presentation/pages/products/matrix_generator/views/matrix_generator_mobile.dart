...
class MatrixGeneratorMobile extends ConsumerStatefulWidget {
  final int productId;
  ...
  @override
  ConsumerState<MatrixGeneratorMobile> createState() =>
      _MatrixGeneratorMobileState();
}

class _MatrixGeneratorMobileState extends ConsumerState<MatrixGeneratorMobile> {
  int _currentStep = 0;
                  ...
                  FilledButton.icon(
                    onPressed: state.generatedVariants.isEmpty
                        ...
                        : () {
                            ...
                            widget.onConfirm(state.generatedVariants);
                          },
