...
class VariantFormDesktop extends ConsumerWidget {
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildCard(
                                context,
                                child: _buildBasicInfoColumn(context, ref),
                              ),
                              ...
                              if (state.type == VariantType.sales) ...[
                                ...
                                _buildCard(
                                  ...
                                  child: VariantSettingsSection(
                                    variant: variant,
                                    stockMinController:
                                        inputs.stockMinController,
                                    stockMaxController:
                                        inputs.stockMaxController,
                                  ),
                                ),
                              ],
                            ],
